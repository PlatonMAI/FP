...
let AST_namespace = str_ws "open" >>. restOfLine true
...
// let AST_primitives = AST_number
//                     <|> AST_string
//                     <|> AST_bool
//                     <|> AST_execute
//                     <|> AST_Variable
// let AST_operationWithBrackets = (str_ws "(" >>. AST_value .>> str_ws ")")
// let AST_operationWithoutBrackets = pipe3 (ws >>. AST_primitives)
//                                     (ws >>. choice [str "+"; str "-"; str "*"; str "/";
//                                     str "=="; str ">="; str "<="; str ">"; str "<"])
//                                     (ws >>. AST_value)
//                                     (fun lhs op rhs -> Application(Application(PFunc(op), lhs), rhs))
// let AST_operation = (attempt AST_operationWithBrackets) <|> AST_operationWithoutBrackets
...
let main_parser = ws >>. many AST_namespace >>. many (str_ws "#") >>. AST_value .>> ws .>> eof
